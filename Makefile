...
image: mod
	gcloud builds submit \
		...
		--tag gcr.io/cloudylabs-public/sentiment-classifier:0.3.3
...
tevent:
	curl -H "Content-Type: application/json" \
		 ...
		 -H "CE-Time: 2018-04-05T03:56:24Z" \
		 -H "CE-Source: https://twitter.com/api/1" \
		 -H "CE-translation: In preparation for the NFL lockout, I am excited to spend twice as much time analyzing my fantasy baseball team. This is great!" \
		 -X POST -d @test-event.json http://localhost:8080/